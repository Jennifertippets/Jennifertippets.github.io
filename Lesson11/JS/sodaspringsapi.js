const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=92d23e29b4ff25e703f6841c5f01cbaa&units=imperial";
fetch(apiURL)
...
fetch(request)
  ...
  .then(function (jsonObject) {
    ...
    const prestons = preston.filter(x => x.name == 'Soda Springs')
    ...
    for (let i = 0; i < preston.length; i++) {
      ...
      document.querySelector('div.notes-one').appendChild(card);
    }
